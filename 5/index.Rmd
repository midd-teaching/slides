...
<iframe src="https://wall.sli.do/event/9nZDVjeotmtiW5SSWx9ZgB?section=6adcce09-3b3c-40dc-9f2c-1e2c8d320be6" width="1000" height="600" style="border:none;"></iframe>
...
- Con un/a colega, recuerda y describe algún evento de la lista a la derecha
- Concéntrate en la descripción (cómo era, con quién estabas, qué sentías, etc.) y **no** en la narración de eventos
- Intenta improvisar durante unos 30 segundos 
- Después reflexiona sobre tus dificultades (¿en qué conjugaciones te equivocas? ¿qué vocabulario te falta? ¿qué aspecto tienes que trabajar más?)
- Toma turnos y prueba con el siguiente tema de la lista
...
- un/a abuelo/a
- tu cumpleaños favorito
- un logro importante (ganar un partido, sacar buena nota)
- tu mejor amigo/a de la infancia
- tu primer recuerdo
- el sitio más bonito de algún viaje
...
---
background-image: url(./assets/img/maleficient.png)
background-size: 700px
background-position: 120% 50%

# Cuento de hadas (remix)

.pull-left[
.large[

- Escoged un cuento de hadas que conozcáis muy bien 
- Cambiad el cuento de alguna manera para contar una historia diferente
  - contar desde la perspectiva de otro personaje
  - añadir un personaje nuevo
  - hacer que ganen los malos
  - etc.
- Pensad en la estructura del cuento
  1. Intro a los personajes, el ambiente
  2. Presentar algún problema
  3. Acción
  4. Resolución del problema, moraleja
